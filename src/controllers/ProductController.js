...
ProductController.createProduct = async (req, res) => {
    ...
    try {
        const { name, description, price, category, maker, stock, measurement, userId, type, // Add handling for 'type' column
...
ProductController.updateProduct = async (req, res) => {
    ...
    try {
        ...
        const { name, description, price, category, maker, stock, measurement, type, Barcode, updateUserId, // Include the update user ID in the request body
         } = req.body;
...
ProductController.createPromotionalProduct = async (req, res) => {
    const productRepository = (0, typeorm_1.getRepository)(Product_1.Product);
