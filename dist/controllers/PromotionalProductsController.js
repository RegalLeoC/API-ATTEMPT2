...
class PromotionalProductController {
    constructor() {
        this.promotionalProductRepository = (0, typeorm_1.getRepository)(PromotionalProduct_js_1.PromotionalProduct);
        this.productRepository = (0, typeorm_1.getRepository)(Product_js_1.Product);
        this.createPromotionalProduct = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const product = yield this.productRepository.findOne({ where: { idproducts: productId } });
                if (!product) {
                ...
                yield this.promotionalProductRepository.save(newPromotionalProduct);
    ...
    getPromotionalProductById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const promotionalProductRepository = (0, typeorm_1.getRepository)(PromotionalProduct_js_1.PromotionalProduct);
                const { id } = req.params;
                const promotionalProduct = yield promotionalProductRepository
                    .createQueryBuilder('promotionalProduct')
                    .leftJoinAndSelect('promotionalProduct.product', 'product')
    ...
    updatePromotionalProduct(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const promotionalProductId = parseInt(req.params.id, 10);
                const promotionalProductRepository = (0, typeorm_1.getRepository)(PromotionalProduct_js_1.PromotionalProduct);
                const promotionalproduct = yield promotionalProductRepository.findOne({ where: { id: promotionalProductId } });
                if (!promotionalproduct) {
                    return res.status(404).json({ error: 'Promotional product not found' });
                }
                ...
                promotionalproduct.active = Boolean(req.body.active);
                yield promotionalProductRepository.save(promotionalproduct);
    ...
    deletePromotionalProduct(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const promotionalProductId = parseInt(req.params.id, 10);
                const promotionalProductRepository = (0, typeorm_1.getRepository)(PromotionalProduct_js_1.PromotionalProduct);
...
//# sourceMappingURL=PromotionalProductsController.js.map