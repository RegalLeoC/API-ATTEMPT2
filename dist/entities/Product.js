...
const PromotionalProduct_js_1 = require("./PromotionalProduct.js");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => User_js_1.User, { eager: true, cascade: true, onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => Statistics_js_1.Statistics, statistics => statistics.product),
    __metadata("design:type", Array)
], Product.prototype, "statistics", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => PromotionalProduct_js_1.PromotionalProduct, promotionalProduct => promotionalProduct.product, { onDelete: 'CASCADE' }),
    __metadata("design:type", Array)
