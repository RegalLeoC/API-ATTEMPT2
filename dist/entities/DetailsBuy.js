...
const Purchase_js_1 = require("./Purchase.js");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Product_js_1.Product),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Purchase_js_1.Purchase, (purchase) => purchase.details),
    (0, typeorm_1.JoinColumn)({ name: 'purchase_id' }),
    __metadata("design:type", Purchase_js_1.Purchase)
], DetailsBuy.prototype, "purchase", void 0);
exports.DetailsBuy = DetailsBuy = __decorate([
    (0, typeorm_1.Entity)()
], DetailsBuy);
//# sourceMappingURL=DetailsBuy.js.map